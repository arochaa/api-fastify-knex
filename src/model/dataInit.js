  ...
  if (!product) {
    await knex.schema
      .createTable('product', (table) => {
        ...
        table.integer('cd_product').notNullable().unique()
        ...
        await knex('product').insert({ price: 740.20, cd_product: 1, image: 'image', brand: 'Xiaomi', title: 'Poco x3 Pro', reviewScore: 0 })
        await knex('product').insert({ price: 840.20, cd_product: 2, image: 'image', brand: 'Sansung', title: 's9', reviewScore: 0 })
        await knex('product').insert({ price: 940.20, cd_product: 3, image: 'image', brand: 'Iphone', title: 'Iphone 6', reviewScore: 0 })
      }
      )
  }
